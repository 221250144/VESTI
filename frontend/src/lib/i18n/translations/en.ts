export const enTranslations = {
  ...
  settings: {
    ...
    modelAccess: {
      ...
      apiKeyPlaceholder: "sk-...",
      modelLabel: "Model",
      recommendedModels: "recommendations available",
      modelPlaceholder: "Enter any model ID",
      maxTokensLabel: "Max output tokens",
      maxTokensOptional: "Auto when blank",
      maxTokensPlaceholder: "Auto",
      maxTokensHint: "Leave blank to let the model or gateway choose the output limit.",
      proxy: "Proxy",
      proxyDesc: "Demo chat and embedding requests use the Vesti gateway. Your selected model ID is passed through; the legacy gateway is used only for retryable network or server failures.",
