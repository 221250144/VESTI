export const koTranslations = {
  ...
  settings: {
    ...
    modelAccess: {
      ...
      apiKeyPlaceholder: "sk-...",
      modelLabel: "모델",
      recommendedModels: "추천 목록 또는 직접 입력",
      modelPlaceholder: "모델 ID를 자유롭게 입력",
      maxTokensLabel: "최대 출력 토큰",
      maxTokensOptional: "비워 두면 자동",
      maxTokensPlaceholder: "자동",
      maxTokensHint: "비워 두면 모델 또는 게이트웨이가 출력 한도를 자동으로 결정합니다.",
      proxy: "프록시",
      proxyDesc: "Demo 채팅과 임베딩은 Vesti 게이트웨이를 사용합니다. 선택한 모델 ID가 그대로 전달되며 기존 게이트웨이는 재시도 가능한 네트워크 또는 서버 장애에만 사용됩니다.",
      proxyChat: "프록시 채팅",
      proxyRoute: "경로",
      proxyBaseUrl: "기본 URL",
      proxyHeader: "헤더",
