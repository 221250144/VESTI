...
export const zhTranslations = {
  ...
  settings: {
    ...
    modelAccess: {
      ...
      apiKeyPlaceholder: "sk-...",
      modelLabel: "模型",
      recommendedModels: "提供推荐列表，也可自由输入",
      modelPlaceholder: "输入任意模型 ID",
      maxTokensLabel: "最大输出 Token",
      maxTokensOptional: "留空为自动",
      maxTokensPlaceholder: "自动",
      maxTokensHint: "留空时由模型或网关自动决定输出上限。",
      proxy: "代理",
      proxyDesc: "Demo 聊天与向量请求统一经 Vesti 网关。所选模型 ID 会直接透传；旧网关仅用于可重试的网络或服务故障。",
      proxyChat: "代理聊天",
      proxyRoute: "路由",
      proxyBaseUrl: "基础地址",
      proxyHeader: "请求头",
